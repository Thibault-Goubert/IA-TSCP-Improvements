...
int64 hash;  /* a (more or less) unique number that corresponds to the
              position */
...
int64 hash_piece[2][6][64];  /* indexed by piece [color][type][square] */
int64 hash_side;
int64 hash_ep[64];
